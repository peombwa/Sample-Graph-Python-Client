...
class ComponentsschemasmicrosoftGraphDevicecompliancepolicystateallof1(Model):
    ...
    :type setting_states:
     list[~users.models.MicrosoftgraphdeviceCompliancePolicySettingState]
    ...
    def __init__(self, setting_states=None, display_name=None, version=None, platform_type=None, state=None, setting_count=None, user_id=None, user_principal_name=None):
        super(ComponentsschemasmicrosoftGraphDevicecompliancepolicystateallof1, self).__init__()
