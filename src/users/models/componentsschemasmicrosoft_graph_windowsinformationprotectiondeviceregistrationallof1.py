...
class ComponentsschemasmicrosoftGraphWindowsinformationprotectiondeviceregistrationallof1(Model):
    ...
    def __init__(self, user_id=None, device_registration_id=None, device_name=None, device_type=None, device_mac_address=None, last_check_in_date_time=None):
        super(ComponentsschemasmicrosoftGraphWindowsinformationprotectiondeviceregistrationallof1, self).__init__()
