...
class MicrosoftgraphmanagedAppOperation(Model):
    ...
    def __init__(self, id=None, display_name=None, last_modified_date_time=None, state=None, version=None):
        super(MicrosoftgraphmanagedAppOperation, self).__init__()
        self.id = id
