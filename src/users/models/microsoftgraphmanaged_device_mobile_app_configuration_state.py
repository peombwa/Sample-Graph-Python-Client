...
class MicrosoftgraphmanagedDeviceMobileAppConfigurationState(Model):
    ...
    def __init__(self, id=None, display_name=None, version=None, platform_type=None, state=None, setting_count=None, user_id=None, user_principal_name=None):
        super(MicrosoftgraphmanagedDeviceMobileAppConfigurationState, self).__init__()
        self.id = id
