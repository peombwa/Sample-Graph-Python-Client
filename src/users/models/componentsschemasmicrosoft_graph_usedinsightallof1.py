...
class ComponentsschemasmicrosoftGraphUsedinsightallof1(Model):
    """usedInsight.
    ...
    def __init__(self, last_used=None, resource_visualization=None, resource_reference=None, resource=None):
        super(ComponentsschemasmicrosoftGraphUsedinsightallof1, self).__init__()
