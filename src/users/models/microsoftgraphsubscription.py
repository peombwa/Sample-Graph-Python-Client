...
class Microsoftgraphsubscription(Model):
    ...
    def __init__(self, id=None, resource=None, change_type=None, client_state=None, notification_url=None, expiration_date_time=None, application_id=None, creator_id=None, include_properties=None, include_resource_data=None, lifecycle_notification_url=None, encryption_certificate=None, encryption_certificate_id=None):
        super(Microsoftgraphsubscription, self).__init__()
        self.id = id
