...
class ComponentsschemasmicrosoftGraphConversationallof1(Model):
    """conversation.
    ...
    def __init__(self, topic=None, has_attachments=None, last_delivered_date_time=None, unique_senders=None, preview=None, threads=None):
        super(ComponentsschemasmicrosoftGraphConversationallof1, self).__init__()
        self.topic = topic
