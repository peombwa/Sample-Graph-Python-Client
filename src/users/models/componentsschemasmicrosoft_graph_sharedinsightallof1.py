...
class ComponentsschemasmicrosoftGraphSharedinsightallof1(Model):
    """sharedInsight.
    ...
    def __init__(self, last_shared=None, sharing_history=None, resource_visualization=None, resource_reference=None, last_shared_method=None, resource=None):
        super(ComponentsschemasmicrosoftGraphSharedinsightallof1, self).__init__()
