...
class MicrosoftgraphappRoleAssignment(Model):
    ...
    def __init__(self, id=None, app_role_id=None, creation_timestamp=None, principal_display_name=None, principal_id=None, principal_type=None, resource_display_name=None, resource_id=None):
        super(MicrosoftgraphappRoleAssignment, self).__init__()
        self.id = id
