...
class MicrosoftgraphpersonAnniversary(Model):
    ...
    def __init__(self, id=None, allowed_audiences=None, inference=None, created_date_time=None, created_by=None, last_modified_date_time=None, last_modified_by=None, type=None, date_property=None):
        super(MicrosoftgraphpersonAnniversary, self).__init__()
        self.id = id
