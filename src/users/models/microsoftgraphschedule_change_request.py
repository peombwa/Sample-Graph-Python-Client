...
class MicrosoftgraphscheduleChangeRequest(Model):
    ...
    def __init__(self, id=None, created_date_time=None, last_modified_date_time=None, last_modified_by=None, assigned_to=None, state=None, sender_message=None, sender_date_time=None, manager_action_message=None, manager_action_date_time=None, sender_user_id=None, manager_user_id=None):
        super(MicrosoftgraphscheduleChangeRequest, self).__init__()
        self.id = id
