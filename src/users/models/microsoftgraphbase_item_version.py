...
class MicrosoftgraphbaseItemVersion(Model):
    ...
    def __init__(self, id=None, last_modified_by=None, last_modified_date_time=None, publication=None):
        super(MicrosoftgraphbaseItemVersion, self).__init__()
        self.id = id
