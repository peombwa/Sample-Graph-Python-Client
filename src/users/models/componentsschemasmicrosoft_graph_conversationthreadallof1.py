...
class ComponentsschemasmicrosoftGraphConversationthreadallof1(Model):
    """conversationThread.
    ...
    def __init__(self, to_recipients=None, topic=None, has_attachments=None, last_delivered_date_time=None, unique_senders=None, cc_recipients=None, preview=None, is_locked=None, posts=None):
        super(ComponentsschemasmicrosoftGraphConversationthreadallof1, self).__init__()
