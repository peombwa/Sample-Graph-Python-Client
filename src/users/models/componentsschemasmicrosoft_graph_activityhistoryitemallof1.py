...
class ComponentsschemasmicrosoftGraphActivityhistoryitemallof1(Model):
    """activityHistoryItem.
    ...
    def __init__(self, status=None, active_duration_seconds=None, created_date_time=None, last_active_date_time=None, last_modified_date_time=None, expiration_date_time=None, started_date_time=None, user_timezone=None, activity=None):
        super(ComponentsschemasmicrosoftGraphActivityhistoryitemallof1, self).__init__()
        self.status = status
