...
class MicrosoftgraphcontactFolder(Model):
    ...
    def __init__(self, id=None, parent_folder_id=None, display_name=None, well_known_name=None, single_value_extended_properties=None, multi_value_extended_properties=None, contacts=None, child_folders=None):
        super(MicrosoftgraphcontactFolder, self).__init__()
        self.id = id
