...
class ComponentsschemasmicrosoftGraphApplogcollectionrequestallof1(Model):
    ...
    def __init__(self, status=None, error_message=None, custom_log_folders=None, completed_date_time=None):
        super(ComponentsschemasmicrosoftGraphApplogcollectionrequestallof1, self).__init__()
        self.status = status
