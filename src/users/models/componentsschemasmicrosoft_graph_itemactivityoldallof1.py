...
class ComponentsschemasmicrosoftGraphItemactivityoldallof1(Model):
    """itemActivityOLD.
    ...
    def __init__(self, action=None, actor=None, times=None, drive_item=None, list_item=None):
        super(ComponentsschemasmicrosoftGraphItemactivityoldallof1, self).__init__()
        self.action = action
        self.actor = actor
        self.times = times
