...
class ComponentsschemasmicrosoftGraphScopedrolemembershipallof1(Model):
    ...
    def __init__(self, role_id=None, administrative_unit_id=None, role_member_info=None):
        super(ComponentsschemasmicrosoftGraphScopedrolemembershipallof1, self).__init__()
