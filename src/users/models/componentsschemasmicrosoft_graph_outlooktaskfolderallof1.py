...
class ComponentsschemasmicrosoftGraphOutlooktaskfolderallof1(Model):
    """outlookTaskFolder.
    ...
    def __init__(self, change_key=None, name=None, is_default_folder=None, parent_group_key=None, tasks=None, single_value_extended_properties=None, multi_value_extended_properties=None):
        super(ComponentsschemasmicrosoftGraphOutlooktaskfolderallof1, self).__init__()
