...
class MicrosoftgraphbaseItem(Model):
    ...
    def __init__(self, id=None, created_by=None, created_date_time=None, description=None, e_tag=None, last_modified_by=None, last_modified_date_time=None, name=None, parent_reference=None, web_url=None, created_by_user=None, last_modified_by_user=None):
        super(MicrosoftgraphbaseItem, self).__init__()
        self.id = id
