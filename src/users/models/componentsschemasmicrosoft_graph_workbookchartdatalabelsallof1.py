...
class ComponentsschemasmicrosoftGraphWorkbookchartdatalabelsallof1(Model):
    ...
    def __init__(self, position=None, separator=None, show_bubble_size=None, show_category_name=None, show_legend_key=None, show_percentage=None, show_series_name=None, show_value=None, format=None):
        super(ComponentsschemasmicrosoftGraphWorkbookchartdatalabelsallof1, self).__init__()
