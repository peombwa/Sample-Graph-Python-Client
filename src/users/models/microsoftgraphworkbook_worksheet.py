...
class MicrosoftgraphworkbookWorksheet(Model):
    ...
    def __init__(self, id=None, name=None, position=None, visibility=None, charts=None, names=None, pivot_tables=None, protection=None, tables=None):
        super(MicrosoftgraphworkbookWorksheet, self).__init__()
        self.id = id
        self.name = name
