...
class MicrosoftgraphworkbookTable(Model):
    ...
    def __init__(self, id=None, highlight_first_column=None, highlight_last_column=None, legacy_id=None, name=None, show_banded_columns=None, show_banded_rows=None, show_filter_button=None, show_headers=None, show_totals=None, style=None, columns=None, rows=None, sort=None, worksheet=None):
        super(MicrosoftgraphworkbookTable, self).__init__()
        self.id = id
