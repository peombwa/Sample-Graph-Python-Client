...
class ComponentsschemasmicrosoftGraphOutlooktaskgroupallof1(Model):
    """outlookTaskGroup.
    ...
    def __init__(self, change_key=None, is_default_group=None, name=None, group_key=None, task_folders=None):
        super(ComponentsschemasmicrosoftGraphOutlooktaskgroupallof1, self).__init__()
