...
class MicrosoftgraphteamsApp(Model):
    ...
    def __init__(self, id=None, external_id=None, name=None, display_name=None, distribution_method=None, app_definitions=None):
        super(MicrosoftgraphteamsApp, self).__init__()
        self.id = id
