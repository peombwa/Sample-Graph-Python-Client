...
class ComponentsschemasmicrosoftGraphPlanneruserallof1(Model):
    """plannerUser.
    ...
    def __init__(self, favorite_plan_references=None, recent_plan_references=None, tasks=None, plans=None, favorite_plans=None, recent_plans=None, all=None):
        super(ComponentsschemasmicrosoftGraphPlanneruserallof1, self).__init__()
