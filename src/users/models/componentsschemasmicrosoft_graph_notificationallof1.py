...
class ComponentsschemasmicrosoftGraphNotificationallof1(Model):
    """notification.
    ...
    def __init__(self, target_host_name=None, expiration_date_time=None, payload=None, display_time_to_live=None, priority=None, group_name=None, target_policy=None):
        super(ComponentsschemasmicrosoftGraphNotificationallof1, self).__init__()
