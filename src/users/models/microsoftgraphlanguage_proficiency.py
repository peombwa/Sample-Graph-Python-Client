...
class MicrosoftgraphlanguageProficiency(Model):
    ...
    def __init__(self, id=None, allowed_audiences=None, inference=None, created_date_time=None, created_by=None, last_modified_date_time=None, last_modified_by=None, display_name=None, tag=None, proficiency=None):
        super(MicrosoftgraphlanguageProficiency, self).__init__()
        self.id = id
