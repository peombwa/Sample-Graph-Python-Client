...
class MicrosoftgraphgroupLifecyclePolicy(Model):
    ...
    def __init__(self, id=None, group_lifetime_in_days=None, managed_group_types=None, alternate_notification_emails=None):
        super(MicrosoftgraphgroupLifecyclePolicy, self).__init__()
        self.id = id
