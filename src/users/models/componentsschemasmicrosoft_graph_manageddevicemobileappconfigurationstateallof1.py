...
class ComponentsschemasmicrosoftGraphManageddevicemobileappconfigurationstateallof1(Model):
    ...
    def __init__(self, display_name=None, version=None, platform_type=None, state=None, setting_count=None, user_id=None, user_principal_name=None):
        super(ComponentsschemasmicrosoftGraphManageddevicemobileappconfigurationstateallof1, self).__init__()
