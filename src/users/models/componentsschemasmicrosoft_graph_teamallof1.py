...
class ComponentsschemasmicrosoftGraphTeamallof1(Model):
    """team.
    ...
    def __init__(self, display_name=None, description=None, internal_id=None, classification=None, specialization=None, visibility=None, web_url=None, member_settings=None, guest_settings=None, messaging_settings=None, fun_settings=None, discovery_settings=None, is_archived=None, schedule=None, photo=None, template=None, channels=None, apps=None, installed_apps=None, operations=None, owners=None, primary_channel=None, group=None):
        super(ComponentsschemasmicrosoftGraphTeamallof1, self).__init__()
