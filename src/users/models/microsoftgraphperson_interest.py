...
class MicrosoftgraphpersonInterest(Model):
    ...
    def __init__(self, id=None, allowed_audiences=None, inference=None, created_date_time=None, created_by=None, last_modified_date_time=None, last_modified_by=None, categories=None, description=None, display_name=None, web_url=None):
        super(MicrosoftgraphpersonInterest, self).__init__()
        self.id = id
