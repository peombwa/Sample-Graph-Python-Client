...
class Microsoftgraphpost(Model):
    """Microsoftgraphpost.
    ...
    def __init__(self, id=None, created_date_time=None, last_modified_date_time=None, change_key=None, categories=None, body=None, received_date_time=None, has_attachments=None, from_property=None, sender=None, conversation_thread_id=None, new_participants=None, conversation_id=None, importance=None, in_reply_to=None, single_value_extended_properties=None, multi_value_extended_properties=None, extensions=None, attachments=None, mentions=None):
        super(Microsoftgraphpost, self).__init__()
        self.id = id
