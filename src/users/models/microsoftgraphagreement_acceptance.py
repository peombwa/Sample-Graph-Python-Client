...
class MicrosoftgraphagreementAcceptance(Model):
    ...
    def __init__(self, id=None, agreement_id=None, user_id=None, agreement_file_id=None, recorded_date_time=None, user_display_name=None, user_principal_name=None, user_email=None, state=None):
        super(MicrosoftgraphagreementAcceptance, self).__init__()
        self.id = id
