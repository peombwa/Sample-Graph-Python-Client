...
class MicrosoftgraphteamsAsyncOperation(Model):
    ...
    def __init__(self, id=None, operation_type=None, created_date_time=None, status=None, last_action_date_time=None, attempts_count=None, target_resource_id=None, target_resource_location=None, error=None):
        super(MicrosoftgraphteamsAsyncOperation, self).__init__()
        self.id = id
