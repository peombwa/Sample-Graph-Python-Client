...
class MicrosoftgraphitemEmail(Model):
    ...
    def __init__(self, id=None, allowed_audiences=None, inference=None, created_date_time=None, created_by=None, last_modified_date_time=None, last_modified_by=None, address=None, display_name=None, type=None):
        super(MicrosoftgraphitemEmail, self).__init__()
        self.id = id
