...
class Microsoftgraphchannel(Model):
    ...
    def __init__(self, id=None, display_name=None, description=None, is_favorite_by_default=None, email=None, web_url=None, membership_type=None, messages=None, chat_threads=None, tabs=None, members=None, files_folder=None):
        super(Microsoftgraphchannel, self).__init__()
        self.id = id
