...
class Microsoftgraphmention(Model):
    ...
    def __init__(self, id=None, mentioned=None, mention_text=None, client_reference=None, created_by=None, created_date_time=None, server_created_date_time=None, deep_link=None, application=None):
        super(Microsoftgraphmention, self).__init__()
        self.id = id
