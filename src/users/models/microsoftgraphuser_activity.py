...
class MicrosoftgraphuserActivity(Model):
    ...
    def __init__(self, id=None, visual_elements=None, activity_source_host=None, activation_url=None, app_activity_id=None, app_display_name=None, content_url=None, created_date_time=None, expiration_date_time=None, fallback_url=None, last_modified_date_time=None, user_timezone=None, content_info=None, status=None, history_items=None):
        super(MicrosoftgraphuserActivity, self).__init__()
        self.id = id
