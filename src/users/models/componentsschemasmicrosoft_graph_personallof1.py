...
class ComponentsschemasmicrosoftGraphPersonallof1(Model):
    """person.
    ...
    def __init__(self, display_name=None, given_name=None, surname=None, birthday=None, person_notes=None, is_favorite=None, email_addresses=None, phones=None, postal_addresses=None, websites=None, title=None, company_name=None, yomi_company=None, department=None, office_location=None, profession=None, sources=None, mailbox_type=None, person_type=None, user_principal_name=None):
        super(ComponentsschemasmicrosoftGraphPersonallof1, self).__init__()
