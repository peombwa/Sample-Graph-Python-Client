...
class MicrosoftgraphitemActivityStat(Model):
    ...
    def __init__(self, id=None, start_date_time=None, end_date_time=None, access=None, create=None, delete=None, edit=None, move=None, is_trending=None, incomplete_data=None, activities=None):
        super(MicrosoftgraphitemActivityStat, self).__init__()
        self.id = id
