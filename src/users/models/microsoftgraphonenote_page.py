...
class MicrosoftgraphonenotePage(Model):
    ...
    def __init__(self, id=None, self=None, created_date_time=None, title=None, created_by_app_id=None, links=None, content_url=None, content=None, last_modified_date_time=None, level=None, order=None, user_tags=None, parent_section=None, parent_notebook=None):
        super(MicrosoftgraphonenotePage, self).__init__()
        self.id = id
        self.self = self
