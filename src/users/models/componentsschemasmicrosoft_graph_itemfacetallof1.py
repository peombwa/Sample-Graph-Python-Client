...
class ComponentsschemasmicrosoftGraphItemfacetallof1(Model):
    """itemFacet.
    ...
    def __init__(self, allowed_audiences=None, inference=None, created_date_time=None, created_by=None, last_modified_date_time=None, last_modified_by=None):
        super(ComponentsschemasmicrosoftGraphItemfacetallof1, self).__init__()
